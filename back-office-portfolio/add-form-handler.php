...
if ($_SESSION['username']) {
    ...
    if ($_POST) {
        ...
        if (
            ...
            isset($_POST['project_github'])&&!empty($_POST['project_github'])&&
            ...
            $githublink = strip_tags($_POST['project_github']);
                ...
                */
                ...
                // if everything is ok, try to upload file
                    ...
                    if (move_uploaded_file($_FILES["project_picture"]["tmp_name"], $target_file)) {
                        echo "Le fichier ". htmlspecialchars( basename( $_FILES["project_picture"]["name"])). " a été téléchargé.";
                        $picture = basename( $_FILES["project_picture"]["name"]) ;


                        $sql = "INSERT INTO projects(project_picture, project_title, project_begin	
                        , project_end, project_context, project_specs, project_github, project_link) VALUES (:project_picture, :project_title,:project_begin,:project_end,:project_context,:project_specs,:project_github,:project_link)";
                        ...
                        $query->bindValue(':project_github', $githublink, PDO::PARAM_STR);
